// ============================================================
// VENDORIZADO VERBATIM do atlas-orbital (src/lib/orbital/time.ts).
// Conversor ÚNICO de tempo da casa — regra M6 da jurisprudência
// (docs/NORTE.md): valor numérico não cruza fronteira de módulo sem
// conversão nomeada e centralizada; para conferir número de terceiro,
// IMPORTA-SE este conversor (re-derivar é onde o bug novo entra).
...
//   Eclipses*, NASA/TP–2006–214141), não implementação; e o oráculo
//   ancora em valores publicados externos ao código (Meeus,
//   *Astronomical Algorithms*, Exemplo 12.a; tabela ΔT histórica),
//   não no próprio coeficiente que testa.
// 2ª prova, ata da revisão de olhos frescos desta onda (Onda 2) —
//   o gate da onda registra o veredito.
//
// Conteúdo abaixo intacto, inclusive comentários em inglês. As
// referências internas do doador (`registry.ts` VALIDITY_RANGES, "W6")
// apontam para a estrutura de lá e ficam como registro histórico.
// ============================================================
