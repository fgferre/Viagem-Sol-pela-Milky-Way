...
// do docs/NORTE.md). Ancora em valores PUBLICADOS, externos ao código:
// a tabela ΔT histórica de Espenak & Meeus e o Exemplo 12.a de Meeus
// (*Astronomical Algorithms*) — GMST verificado contra exemplo resolvido
// da literatura, não contra o próprio coeficiente que implementa.
// Limiares intocados (jurisprudência: limiar de oráculo não se afrouxa).
// Adaptação prevista era só o import path; `./time` resolve igual aqui
// porque o teste mora ao lado do módulo — zero mudança de conteúdo.
// ============================================================
