...
| **Filmes viram roteiro lido por um motor** | Dono em 22/08 — as palavras dele inteiras e o que fica decidido moram no **item 75** do `PENDENCIAS.md`, que é o dono do assunto; o critério técnico de saída é o item 1 da fila do `PLANO-CINEMA.md` | — (em implementação; estado no item 75) |
