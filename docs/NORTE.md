...
- A fase `atlas` é fase de verdade; o portal devolve o filme exato
  ...
  filme atrás (`?atlas=1`, o botão da abertura) a vista de abertura
  continua bit a bit a de sempre.
