...
**PRÓXIMO PASSO, aguardando aprovação do usuário:** a rodada de emissão 2 braços
(peso por braço em lâminas + partículas, gás continua 4). Ela desbloqueia o merge da
`quad-unico` e completa "sem truques de sprite". Depois dela, a fila é: unificação 2
(cascas de wrap por bin de magnitude absoluta, com floating origin junto — desenho completo
em `memory/procedural-star-population.md` do agente e resumido acima).
