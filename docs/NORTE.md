...
| **Filmes viram roteiro lido por um motor** | Dono em 22/08 — as palavras dele inteiras e o que fica decidido moram no **item 75** do `PENDENCIAS.md`; o contrato de autoria é o `PLANO-CINEMA.md`. As 25 cenas e os 193 s do filme galáctico já são roteiro; falta somente o fechamento visual e da suíte | — (fechamento do item 75) |
