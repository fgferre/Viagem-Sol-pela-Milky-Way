...
As três vistas da abertura do filme (`sol`, `soldisco`, `solestouro`)
só mudam de referência com o **sim do dono**, fotos abertas. (Eram
quatro: `solrampa` saiu no corte aprovado do item 113, 30/08 — as
pontas seguram a rampa.)
...
- **A DOSE DO PRÉ-AQUECIMENTO é por CORPO, e o gate manda no resto**
  ...
  **1.200 MiB de texel** (1.146 deles de corpo; 38 texturas, 36,5 MiB
  ...
  declara os corpos e o momento. A fuga em `revelacao.json` pede TERRA e
  LUA no estilingue (REVEAL_T), e só elas; `preAquecimento` aplica a dose.
...
| **Filmes viram roteiro lido por um motor** | Dono em 22/08 — o item 75 fechou em 29/08 e sua história mora no `PENDENCIAS-ARQUIVO.md`; o contrato de autoria é o `PLANO-CINEMA.md`. As 25 cenas e os 193 s do filme galáctico são roteiro, inclusive câmera, lente, efeitos, preparação, marcos, edição e nomes dirigidos | Motor pronto; o próximo filme é o solar (item 100) |
