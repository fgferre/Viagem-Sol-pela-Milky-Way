...
engordou dois deles em vereditos e não em minutos** (medido em 22/08):
`a11y` foi de 209 a 238 e continua em 4,5 min; `busca-smoke` foi de 31 a
33 e continua em 1,9 min.
