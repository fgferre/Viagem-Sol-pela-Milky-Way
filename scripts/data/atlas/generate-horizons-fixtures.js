...
const TARGET_BODIES = [
  ...
  // Casa: Hygiea (asteroide 10) — Onda 2 a tira do Kepler de catálogo e a
  // põe no pipeline osculante, com fixtures próprias para o juiz de regressão.
  { id: "hygiea", command: "10;", center: "500@10", name: "Hygiea" },
];
