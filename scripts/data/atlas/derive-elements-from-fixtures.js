...
//      30–100 s e foi ELE quem gerou os epochJD embarcados nas tabelas que
//      migram verbatim (2025-01-01 → ΔT 77,17 s; o Espenak–Meeus do
//      src/lib/atlas/time.ts dá 74,5 s — 2,6 s de diferença, 0,03° em Fobos,
//      abaixo de todo limiar do oráculo). Trocar o conversor aqui quebraria a
//      reprodução exata dos blocos já embarcados; o conversor ÚNICO do
//      runtime (regra M6) segue sendo o time.ts. O checklist pré-fusão
//      (item 7) pedia "casar exatamente" — a medição mostrou que o doador
//      nunca casou, e o desvio registrado aqui é a forma honesta de herdar.
// ============================================================
...
// Casa: o script vive em scripts/data/atlas/, três níveis abaixo da raiz.
const FIXTURES_DIR = path.join(
  __dirname,
  "../../../src/test/fixtures/horizons"
);
...
const BODIES = {
  ...
  // Casa: Hygiea — a adição da Onda 2 (sai do Kepler de catálogo do doador).
  hygiea: { parent: "sun", epoch: "2025-01-01" },
};
